        ...
        <section className="nav__section2">
            <div className='nav__section2__content'>
                <ul className='nav__section2__lists__one nav__section2__lists '>
                    ...
                    <li className='nav__section2__list'><NavLink to='/eb/home/tvseries' style={ ({isActive}) => ( { color : isActive ? 'white' : 'rgb(102, 99, 99)'})} className='nav__section2__list__link'></NavLink></li>
                </ul>
