function SnGbanner() {
    return (
        <div className='sgbanner__section' style={{ backgroundImage: `url("https://image.tmdb.org/t/p/original/${banner?.backdrop_path}")`, backgroundPosition: 'center', backgroundSize: "cover" }}>
