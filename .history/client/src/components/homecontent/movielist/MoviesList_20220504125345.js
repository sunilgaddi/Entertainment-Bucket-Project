...
function MoviesList() {
  ...
  return (
    <div className='movie__list'>
          ...
          <MoviesRow data={topRated} title={"Top Rated"} panel={'movie'}/>
          <MoviesRow data={actionMovies} title={"Action"} panel={'movie'}/>
          <MoviesRow data={horrorMovies} title={"Horror"} panel={'movie'}/>
          <MoviesRow data={comedyMovies} title={"Comedy"} panel={'movie'}/>
          <MoviesRow data={romanceMovies} title={"Romance"} panel={'movie'}/>
          <MoviesRow data={documentriesMovies} title={"Documentry"} panel={'movie'}/>
    </div>
  )
}
