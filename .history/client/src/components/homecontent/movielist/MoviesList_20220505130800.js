...
function MoviesList() {
  ...
  return (
    <div className='movie__list'>
          ...
          <MoviesRow data={topRated} title={"Top Rated"} anel={'movie'}/>
          <MoviesRow data={actionMovies} title={"Action"} anel={'movie'}/>
          <MoviesRow data={horrorMovies} title={"Horror"} anel={'movie'}/>
          <MoviesRow data={comedyMovies} title={"Comedy"} anel={'movie'}/>
          <MoviesRow data={romanceMovies} title={"Romance"} anel={'movie'}/>
          <MoviesRow data={documentriesMovies} title={"Documentry"} anel={'movie'}/>
    </div>
  )
}
