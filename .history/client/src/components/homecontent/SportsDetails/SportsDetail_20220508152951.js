    ...
    return (
        <div className="sportsdetail__container">
            <div className='match__details__table'>
                <table>
                    <tbody>
                        <tr className='row-1 rows'>
                            <td>{matchDetails?.match_number}</td>
                            <td></td>
                            <td>{matchDetails?.match_date}</td>
                        </tr>
                        <tr className='row-2 rows'>
                            <td><img className="team__logo" src={`${teamLogo1}`}/> {matchDetails?.team_one?.team_name}</td>
                            <td></td>
                            <td>{matchDetails?.team_one?.team_score} {matchDetails?.team_one?.team_overs_played}</td>
                        </tr>
                        <tr className='row-3 row'>
                            <td><img className="team__logo" src={`${teamLogo2}`}/> {matchDetails?.team_two?.team_name}</td>
                            <td></td>
