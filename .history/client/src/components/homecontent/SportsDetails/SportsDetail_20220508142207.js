...
function SportsDetails() {
    ...
    return(
        <div className="sportsdetail__container">
            <div className='sportsdetail__banner' style={{ backgroundImage: `url(${matchPoster?.banner})`, backgroundPosition:"center" , backgroundSize:"contain",backgroundRepeat:"no-repeat"}}></div>
        </div>
    )
}
