                ...
                <table cellSpacing={10} >
                    <tbody>
                        <tr className='row-1 row'>
                            ...
                            <td></td>
                            <td className='match__number__date'>{matchDetails?.match_date}</td>
                        </tr>
                        <tr className='row-2 row'>
                            ...
                            <td></td>
                            <td className='team__name__score'>{matchDetails?.team_one?.team_score} {matchDetails?.team_one?.team_overs_played}</td>
                        </tr>
                        <tr className='row-3 row'>
                            <td className='team_-name_log team__name__score'><img className="team__logo" src={`${teamLogo2}`}/> {matchDetails?.team_two?.team_name}</td>
                            <td></td>
