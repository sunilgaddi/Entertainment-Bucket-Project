...
function TvSeriesPanel() {
    ...
    return (
        <div className='tv__container'>
            ...
            <MoviesRow data={familyTv} title={"Family"} mainPanel={'tv'} />
            <MoviesRow data={actionTv} title={"Action"} mainPanel={'tv'}/>
            <MoviesRow data={mysteryTv} title={"Mystery"} mainPanel={'tv'} />
            <MoviesRow data={comedyTv} title={"Comedy"} mainPanel={'tv'} />
            <MoviesRow data={scifinFantasyTv} title={"Sci Fi & Fantasy"} mainPanel={'tv'} />
            <MoviesRow data={documentriesTv} title={"Documentry"} mainPanel={'tv'} />
        </div>
    )
}
